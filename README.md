...
| 20 sep 2026 | Normalización con `logNormCounts` | Estándar de Bioconductor; equivale a `LogNormalize` de la clase 1 | — |
| 20 sep 2026 | 2,000 genes variables con `modelGeneVar` y `getTopHVGs` | Es la convención, no un resultado; construyen el espacio y no sirven para anotar | — |
...
| 20 sep 2026 | UMAP con los valores por defecto de `runUMAP`, 15 PCs y semilla 20260903 | Un UMAP se usa para comunicar, no para derivar conclusiones | — |
| 20 sep 2026 | Agrupamiento con Louvain, k = 20 y 15 PCs | Da 10 clústeres de 77 a 741 células | — |
